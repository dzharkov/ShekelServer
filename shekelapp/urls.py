...
urlpatterns = [
    ...
    # ex: event_id/5/consumed/4
    url(r'^event_id/(?P<receipt_id>[0-9]+)/consumed/(?P<user_id>[0-9]+)/$', views.user_consumed_r, name='user_consumed_r'),
    # ex: event_id/consumed/4
    url(r'^event_id/consumed/(?P<user_id>[0-9]+)/$', views.user_consumed, name='user_consumed'),
